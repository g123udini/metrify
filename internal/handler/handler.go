...
func NewHandler(ms service.Storage, logger *zap.SugaredLogger, db *sql.DB, audit *audit.Publisher, dump bool, key string, privKey *rsa.PrivateKey, trustedSubnet string) *Handler {
	return &Handler{
		ms:                 ms,
		logger:             logger,
		db:                 db,
